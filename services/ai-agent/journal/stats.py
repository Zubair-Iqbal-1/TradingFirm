...
Every group carries the model (spec 4.5 decision 13): model × verdict ×
horizon, and calibration per model and horizon. No rate or mean is ever
computed across models — 4.8 puts two models' verdicts on the same tickers.
